 ...
 *       Filename:  draw.cpp
 *
 *    Description:  Some draw helper functions
 *
 *        Version:  1.0
 *        Created:  24.04.2018 11:19:57
 *       Revision:  none
 *       Compiler:  gcc
 *
...
TGraphErrors * DataGraph(const list<ScanPoint_t> & SPL, string title)
{
...
void draw_fitresult(TauMassFitter2 & fitter, double MSHIFT)
{
	TCanvas * sigma_c = new TCanvas("sigma", "sigma", 1.2*640,1.2*480); 
	sigma_c->SetGrid();
  TMultiGraph * mg = new TMultiGraph;
